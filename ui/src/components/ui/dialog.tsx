  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        ...
        data-open:fade-in-0 bg-black/10 duration-100
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          data-open:zoom-in-95 ring-foreground/10 grid max-w-[calc(100%-2rem)]
          gap-4 rounded-none p-4 text-xs/relaxed ring-1 duration-100 sm:max-w-sm
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        `text-muted-foreground *:[a]:hover:text-foreground text-xs/relaxed
